...
export default function Playground() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-zinc-950">
      ...
      <div className="lg:hidden sticky top-0 z-40 border-b border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 px-4 py-3">
        <div className="flex gap-2">
          <button
            type="button"
            onClick={showToast}
            className="flex-1 rounded-lg bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900 text-[13px] font-semibold px-4 py-2 hover:opacity-90 active:scale-[0.98] transition-all duration-150"
          >
            Show Toast
          </button>
          ...
          <button
            type="button"
            onClick={closeAll}
            className="flex-1 rounded-lg border border-zinc-200 dark:border-zinc-700 text-zinc-600 dark:text-zinc-400 text-[13px] font-medium px-4 py-2 hover:bg-zinc-50 dark:hover:bg-zinc-800 active:scale-[0.98] transition-all duration-150"
          >
            Close All
          </button>
        </div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-14">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-6 lg:gap-8 items-start">
          ...
          {/* Right: Code preview */}
          <div className="order-2 sticky top-30 z-50 hidden lg:flex flex-col gap-4">
            <div className=''>
              {/* Action Buttons */}
